...
class _RechercheScreenState extends State<RechercheScreen> {
  ...
  Future<void> _verifier() async {
    ...
    setState(() {
      ...
      _resultat = result['success']
        ? result['diplome']
        : Diplome(
            matricule: val, nomComplet: '', diplome: '', mention: '',
  ...
  void _reinitialiser() {
    _ctrl.clear();
    setState(() { _resultat = null; _searched = false; });
  }
                    ...
                    Row(children: [
                      Expanded(
                        child: TextField(
                          ...
                          style: GoogleFonts.epilogue(fontSize: 13, color: AppColors.text),
                          decoration: InputDecoration(
                            hintText: 'Ex : UO2-2024-1187 ou SAWADOGO...',
                            fillColor: Colors.white,
                            filled: true,
                            prefixIcon: const Icon(Icons.badge_outlined, color: AppColors.gris3, size: 20),
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: const Icon(Icons.search_rounded, color: AppColors.noir, size: 24),
                        ),
                      ),
                    ]),
                  ],
            ...
            child: Column(
              ...
              children: [
                Text('EXEMPLES DE RECHERCHE',
                  style: GoogleFonts.epilogue(fontSize: 9, letterSpacing: 2, color: AppColors.sub,
                ...
                ...[
                  ...
                  child: GestureDetector(
                    onTap: () { _ctrl.text = e.$2; _verifier(); },
                    child: Container(
                      ...
                      child: Row(children: [
                        Expanded(child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(e.$1, style: GoogleFonts.epilogue(fontSize: 10, color: AppColors.sub)),
                            Text(e.$2, style: GoogleFonts.syne(fontSize: 13, fontWeight: FontWeight.w600, color: AppColors.text)),
                          ],
                        )),
                        const Icon(Icons.arrow_forward_ios_rounded, size: 12, color: AppColors.gris3),
                      ]),
                    ),
                  ),
                )),
